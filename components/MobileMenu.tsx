      ...
      {isMenuMounted && (
        ...
        >
          ...
          <li
            ...
            style={{ transitionDelay: '150ms' }}
          >
            <Link href="/menu_choonsam" className="flex w-auto pb-4">
              춘삼 메뉴판
            </Link>
          </li>
          ...
          >
            <Link href="/menu_hd_underground" className="flex w-auto pb-4">
              홍대 언더그라운드 메뉴판
            </Link>
          </li>
          ...
          <li
            ...
            style={{ transitionDelay: '175ms' }}
          >
            <Link href="/music" className="flex w-auto pb-4">
               MUSIC
            </Link>
          ...
          <li
            ...
            style={{ transitionDelay: '175ms' }}
          >
            <Link href="/photo" className="flex w-auto pb-4">
               PHOTO
            </Link>
            ...
            style={{ transitionDelay: '175ms' }}
          >
             <Link href="/ready" className="flex w-auto pb-4">
               Instagram 공유
            </Link>
