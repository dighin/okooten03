    ...
    <Suspense fallback={null}>
      <Container>
        <div className="flex flex-col justify-center items-start max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pb-16  w-full">
          <div className="flex flex-col-reverse sm:flex-row items-start w-full h-full">
            ...
            <div className="w-full sm:w-[176px] relative mb-8 sm:mb-0 mr-auto">
              <Image
                alt="Lee Robinson"
                height={200}
                width={176}
                src="/okooten_logo.png"
                sizes="30vw"
                priority
